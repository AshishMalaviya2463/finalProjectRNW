...
import { logInUserAction, signInWithGoogleAction } from '../redux/actions/authAction';
...
const Login = () => {
    ...
    const { handleSubmit, handleBlur, errors, touched, handleChange } = formik;
    ...
    return (
        <>
            ...
            <Formik values={formik}>
                <Form onSubmit={handleSubmit} className="bg-white pt-5 px-5 contact-form">
                    ...
                    <div className='text-center mb-5 font-weight-bold p-0 nav-item'>
                        ...
                        <div>
                            <IconButton aria-label="fingerprint" color="primary" onClick={() => dispatch(signInWithGoogleAction())}>
                                <GoogleIcon />
                            </IconButton>
                        </div>
                    </div>
